...
<html>
	<head>
		...
		<title><g:message code="default.button.mostrarDetalle.label"/> <g:message code="default.palabra.minus.armero"/></title>
	</head>
	<body>
		...
		<div id="show-armero" class="content scaffold-show" role="main">
			...
			<div class="panel colourable">
				<div class="panel-heading">
					<span class="panel-title"><g:message code="default.button.mostrarDetalle.label"/> <g:message code="default.palabra.minus.armero"/></span>
				</div>
