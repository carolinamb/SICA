...
<html>
	...
	<body>
		<a href="#create-cartucho" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-cartucho" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:cartuchoInstance, action:'save']" >
				<fieldset class="form">
