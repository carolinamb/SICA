...
<html>
	<head>
		...
		<title><g:message code="default.button.crearNuevo.label"/> <g:message code="default.palabra.minus.grado"/></title>
	</head>
	<body>
		...
		<div id="create-grado" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:gradoInstance, action:'save']" >
				<fieldset class="form">
