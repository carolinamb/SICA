		...
		<div id="show-turno" class="content scaffold-show" role="main">
                ...
                <div class="panel-body">
				    ...
				    <g:if test="${turnoInstance?.descripcion}">
                        ...
                        <div class="fieldcontain col-sm-6">
                             <span id="descripcion-label" class="property-label col-sm-4 text-bold"><g:message code="turno.descripcion.label" default="Descripcion" /></span>
					
						    <span class="property-value col-sm-8" aria-labelledby="descripcion-label"><g:fieldValue bean="${turnoInstance}" field="descripcion"/></span>
			...
			<g:form url="[resource:turnoInstance, action:'delete']" method="DELETE">
                <div class="btn-group btn-group-xs">
                    <g:link class="btn btn-warning" action="edit" resource="${turnoInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
