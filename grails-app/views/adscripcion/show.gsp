		...
		<div id="show-adscripcion" class="content scaffold-show" role="main">
                ...
                <div class="panel-body">
                    ...
                    <g:if test="${adscripcionInstance?.descripcion}">
                        <div class="fieldcontain col-sm-6">
                           <span id="descripcion-label" class="property-label col-sm-4 text-bold"><g:message code="adscripcion.descripcion.label" default="Descripcion" /></span>

                           <span class="property-value col-sm-8" aria-labelledby="descripcion-label"><g:fieldValue bean="${adscripcionInstance}" field="descripcion"/></span>
			            </div>
				    </g:if>
                </div>
            </div>
			<g:form url="[resource:adscripcionInstance, action:'delete']" method="DELETE">
                <div class="btn-group btn-group-xs">
                    <g:link class="btn btn-warning" action="edit" resource="${adscripcionInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
