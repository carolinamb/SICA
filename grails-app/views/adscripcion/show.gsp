...
<html>
	...
	<body>
		<a href="#show-adscripcion" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="show-adscripcion" class="content scaffold-show" role="main">
			...
			<ol class="property-list adscripcion">
			...
			<g:form url="[resource:adscripcionInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${adscripcionInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
